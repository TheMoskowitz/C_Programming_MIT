...
{
	struct student *ptr1 = (struct student*)a;
	struct student *ptr2 = (struct student*)b;

	return strcmp(ptr1->fname, ptr2->fname);
...
{
	struct student *ptr = (struct student*)prec;
	if (ptr->age > *((int*)arg)) printrec(ptr, NULL);
